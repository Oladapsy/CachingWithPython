# CachingWithPython
## Implement a simple cache that implements these methods:


### Set: it takes 3 parameters; the key for the data, the data to cache and the lifetime for the data (ttl)
